...
This project is indexed by GitNexus as **voice-agent** (412 symbols, 942 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
