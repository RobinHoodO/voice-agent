...
This project is indexed by GitNexus as **voice-agent** (358 symbols, 813 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
